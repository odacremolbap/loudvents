...
import (
	...
	"github.com/odacremolbap/loudvents/pkg/client/generated/clientset/internalclientset/scheme"
...
func (c *MessagingV1alpha1Client) LoudVentsChannels(namespace string) LoudVentsChannelInterface {
	return newLoudVentsChannels(c, namespace)
}
