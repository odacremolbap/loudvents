...
import (
	...
	internalclientsetscheme "github.com/odacremolbap/loudvents/pkg/client/generated/clientset/internalclientset/scheme"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := loudventschannelInformer.Lister()
